namespace PaayesTests
{
    ...
    public class InvoiceTest : BasePaayesTest
    {
        public InvoiceTest(PaayesMockFixture paayesMockFixture)
        ...
        {
            // TODO: assert that tax_rate is not null. Today paayes-mock does not support this
            string[] expansions =
            {
              "charge",
              "customer",
