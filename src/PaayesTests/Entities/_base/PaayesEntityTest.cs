namespace PaayesTests
{
    ...
    public class PaayesEntityTest : BasePaayesTest
    {
        public PaayesEntityTest(
        ...
        public void FromJsonAuto()
        {
            ...
            var o = PaayesEntity.FromJson(json);
        ...
        public void FromJsonGeneric()
        {
            ...
            var o = PaayesEntity.FromJson<TestEntity>(json);
        ...
        {
            var service = new SubscriptionService(this.PaayesClient);
        ...
        private class TestEntity : PaayesEntity<TestEntity>
        {
        ...
        private class TestNestedEntity : PaayesEntity<TestNestedEntity>, IHasId
        {
            [JsonProperty("id")]
