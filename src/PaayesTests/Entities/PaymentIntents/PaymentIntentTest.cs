namespace PaayesTests
{
    ...
    public class PaymentIntentTest : BasePaayesTest
    {
        public PaymentIntentTest(PaayesMockFixture paayesMockFixture)
        ...
        {
            // Do not test expanding `source` as it is not supported by paayes-mock
        ...
        public void DeserializeNextActionRedirectToUrl()
        {
            ...
            Assert.Equal("https://paayes.com", intent.NextAction.RedirectToUrl.Url);
            Assert.Equal("https://paayes.com/return", intent.NextAction.RedirectToUrl.ReturnUrl);
        }
