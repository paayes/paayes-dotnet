namespace PaayesTests
{
    ...
    public class BalanceTransactionTest : BasePaayesTest
    {
        public BalanceTransactionTest(PaayesMockFixture paayesMockFixture)
        ...
        public void DeserializeWithExpansions()
        {
            ...
            var balanceTransactions = JsonConvert.DeserializeObject<PaayesList<BalanceTransaction>>(json);
            ...
            Assert.IsType<Paayes.Issuing.Authorization>(balanceTransactions.Data[8].Source);
            ...
            Assert.IsType<Paayes.Issuing.Transaction>(balanceTransactions.Data[9].Source);
