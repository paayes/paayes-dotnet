namespace PaayesTests
{
    ...
    public class ExternalAccountServiceTest : BasePaayesTest
    {
        ...
        {
            this.service = new ExternalAccountService(this.PaayesClient);
        ...
        // paayes-mock does not return a bank account object on list today so we do not test
