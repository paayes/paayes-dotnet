namespace PaayesTests
{
    ...
    public class BankAccountServiceTest : BasePaayesTest
    {
        ...
        {
            this.service = new BankAccountService(this.PaayesClient);
        ...
        // paayes-mock does not return a bank account object on update today so we do not test
