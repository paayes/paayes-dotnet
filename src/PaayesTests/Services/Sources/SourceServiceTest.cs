namespace PaayesTests
{
    ...
    public class SourceServiceTest : BasePaayesTest
    {
        ...
        {
            this.service = new SourceService(this.PaayesClient);
        ...
        public void Attach()
        {
            ...
            // We can't test the object returned as paayes-mock returns an Account
