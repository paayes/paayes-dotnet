namespace PaayesTests
{
    ...
    public class AutoPagingTest : BasePaayesTest
    {
        ...
        public void ListAutoPaging()
        {
            ...
            var service = new PageableService(this.PaayesClient);
        ...
        public class PageableModel : PaayesEntity<PageableModel>, IHasId
        {
            [JsonProperty("id")]
        ...
        {
            public PageableService(IPaayesClient client)
                : base(client)
            {
            }
