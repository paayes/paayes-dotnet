namespace PaayesTests
{
    ...
    public class ServiceTest : BasePaayesTest
    {
        [Fact]
        ...
        private class TestClient : IPaayesClient
        {
        ...
        private class TestEntity : PaayesEntity, IHasId
        {
            [JsonProperty("id")]
        ...
        {
            public TestService(IPaayesClient client)
                : base(client)
            {
            }
            ...
            public virtual PaayesList<TestEntity> List(ListOptions options = null, RequestOptions requestOptions = null)
            {
                return this.ListEntities(options, requestOptions);
            }

            public virtual Task<PaayesList<TestEntity>> ListAsync(ListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
            {
