namespace PaayesTests
{
    ...
    public class QuoteServiceTest : BasePaayesTest
    {
        ...
        {
            this.service = new QuoteService(this.PaayesClient);
        ...
        public void Pdf()
        {
            ...
            Assert.Equal("Paayes binary response", new StreamReader(stream).ReadToEnd());
        }
