namespace PaayesTests
{
    ...
    /// <summary>
    /// This test checks that <see cref="Paayes.PaayesEntity" /> subclasses that have a
    ...
    public class DontSerializeNullDeletedAttrs : WholesomeTest
    {
        ...
        public void Check()
        {
            ...
            // Get all PaayesEntity subclasses
            var entityClasses = GetSubclassesOf(typeof(PaayesEntity));
