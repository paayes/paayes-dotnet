namespace PaayesTests
{
    ...
    public class AnyOfConverterTest : BasePaayesTest
    {
        [Fact]
        ...
        private class TestSubObject : PaayesEntity<TestSubObject>, IHasId
        {
            [JsonProperty("id")]
        ...
        private class TestObject : PaayesEntity<TestObject>
        {
            [JsonProperty("any_of")]
