namespace PaayesTests
{
    ...
    public class ExpandableFieldConverterTest : BasePaayesTest
    {
        [Fact]
        ...
        private class TestNestedObject : PaayesEntity<TestNestedObject>, IHasId
        {
            [JsonProperty("id")]
        ...
        private class TestTopLevelObject : PaayesEntity<TestTopLevelObject>
        {
            [JsonIgnore]
