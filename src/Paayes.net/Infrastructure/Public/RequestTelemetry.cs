namespace Paayes
{
    ...
    public class RequestTelemetry
    {
        ...
        /// a <c>X-Paayes-Client-Telemetry</c> header with the item; otherwise, do nothing.
        /// </summary>
        /// <param name="headers">The request headers.</param>
        public void MaybeAddTelemetryHeader(IDictionary<string, string> headers)
        {
            if (headers.ContainsKey("X-Paayes-Client-Telemetry"))
            {
                return;
            }
            ...
            headers.Add("X-Paayes-Client-Telemetry", JsonUtils.SerializeObject(payload, Formatting.None));
        }
