namespace Paayes.Infrastructure
{
    using System;
    ...
    /// <summary>
    /// This converter can be used to deserialize any Paayes object. It is mainly useful for
    ...
    /// </summary>
    public class PaayesObjectConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            throw new NotSupportedException("PaayesObjectConverter should only be used while deserializing.");
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type concreteType = PaayesTypeRegistry.GetConcreteType(objectType, objectValue);
