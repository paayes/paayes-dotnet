...
namespace Paayes.Sigma
{
    ...
    public class ScheduledQueryRun : PaayesEntity<ScheduledQueryRun>, IHasId, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// When the query was run, Sigma contained a snapshot of your Paayes data at this time.
        /// </summary>
        [JsonProperty("data_load_time")]
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime DataLoadTime { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime ResultAvailableUntil { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
