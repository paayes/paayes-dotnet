...
namespace Paayes
{
    ...
    public class Invoice : PaayesEntity<Invoice>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// owner's Paayes account when the invoice is paid.
        /// </summary>
        ...
        /// href="https://docs.paayes.com/billing/invoices/workflow/#auto_advance">automatic
        ...
        /// Paayes will attempt to pay this invoice using the default source attached to the
        /// customer. When sending an invoice, Paayes will email this invoice to the customer with
        ...
        public PaayesError LastFinalizationError { get; set; }
        ...
        /// </summary>
        [JsonProperty("lines")]
        public PaayesList<InvoiceLineItem> Lines { get; set; }
        ...
        /// account. See the <a href="https://docs.paayes.com/billing/invoices/connect">Invoices
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime PeriodEnd { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime PeriodStart { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// href="https://docs.paayes.com/billing/invoices/workflow#workflow-overview">Learn
        /// more</a>.
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime SubscriptionProrationDate { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// href="https://docs.paayes.com/billing/webhooks#understand">been exhausted</a>. This
