...
namespace Paayes
{
    ...
    public class DisputeEvidence : PaayesEntity<DisputeEvidence>
    {
        /// <summary>
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) Your
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) Any
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) A
        ...
        /// <summary>
        /// The Paayes ID for the prior charge which appears to be a duplicate of the disputed
        /// charge.
        /// </summary>
