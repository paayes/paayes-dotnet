namespace Paayes
{
    ...
    public class OAuthToken : PaayesEntity<OAuthToken>
    {
        /// <summary>
        /// <para>
        /// The access token you can use to make requests on behalf of this Paayes account. Use it
        /// as you would any Paayes secret API key.
        /// </para>
        /// <para>
        /// This key does not expire, but may be revoked by the user at any time (you'll get a
        /// <c>account.application.deauthorized</c>
        /// <see href="https://docs.paayes.com/api/events/types#event_types-account.application.authorized">webhook event</see>
        /// when this happens).
        /// </para>
        /// </summary>
        /// <remarks>
        ...
        /// <see cref="PaayesUserId"/>.
        /// </remarks>
        [Obsolete("Use PaayesUserId instead.")]
        ...
        /// live mode (where
        /// <see href="https://docs.paayes.com/connect/testing#test-keys-for-livemode-applications">applicable</see>).
        /// </summary>
        /// <remarks>
        ...
        /// conjunction with the connected account's ID found in <see cref="PaayesUserId"/>.
        /// </remarks>
        [Obsolete("Use PaayesUserId instead.")]
        ...
        /// </remarks>
        [Obsolete("Use PaayesUserId instead.")]
        [JsonProperty("paayes_publishable_key")]
        public string PaayesPublishableKey { get; set; }
