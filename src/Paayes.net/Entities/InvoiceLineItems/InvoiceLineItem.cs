...
namespace Paayes
{
    ...
    public class InvoiceLineItem : PaayesEntity<InvoiceLineItem>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// The ID of the <a href="https://docs.paayes.com/api/invoiceitems">invoice item</a>
