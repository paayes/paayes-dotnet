...
namespace Paayes
{
    ...
    public class Coupon : PaayesEntity<Coupon>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// href="https://docs.paayes.com/currencies">ISO code for the currency</a> of the amount to
        /// take off.
        /// </summary>
