...
namespace Paayes
{
    ...
    public class Refund : PaayesEntity<Refund>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// <c>requested_by_customer</c>) or generated by Paayes internally
        ...
        /// came from another Paayes account. See the Connect documentation for details.
        /// </summary>
        [JsonIgnore]
        ...
        /// href="https://docs.paayes.com/refunds#failed-refunds">refunds</a> documentation for more
        /// details.
        /// </summary>
        [JsonProperty("status")]
