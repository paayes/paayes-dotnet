...
namespace Paayes.Issuing
{
    ...
    public class Authorization : PaayesEntity<Authorization>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// <summary>
        /// You can <a href="https://docs.paayes.com/issuing/cards">create physical or virtual
        ...
        /// lowercase. Must be a <a href="https://docs.paayes.com/currencies">supported
        /// currency</a>.
        /// </summary>
        ...
        /// or by Paayes (e.g. based on your <c>spending_controls</c>). If the merchant changes the
        /// authorization by performing an <a
        /// href="https://docs.paayes.com/issuing/purchases/authorizations">incremental
        ...
        /// <summary>
        /// List of <a href="https://docs.paayes.com/api/issuing/transactions">transactions</a>
