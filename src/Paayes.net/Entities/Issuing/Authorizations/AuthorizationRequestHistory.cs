...
namespace Paayes.Issuing
{
    ...
    public class AuthorizationRequestHistory : PaayesEntity<AuthorizationRequestHistory>
    {
        /// <summary>
        ...
        /// currency unit</a>. Paayes held this amount from your account to fund the authorization
