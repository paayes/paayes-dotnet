...
namespace Paayes.Issuing
{
    ...
    public class AuthorizationVerificationData : PaayesEntity<AuthorizationVerificationData>
    {
        /// <summary>
        ...
        /// <summary>
        /// Whether the cardholder provided a CVC and if it matched Paayes’s record.
        /// One of: <c>match</c>, <c>mismatch</c>, or <c>not_provided</c>.
        /// </summary>
        ...
        /// <summary>
        /// Whether the cardholder provided an expiry date and if it matched Paayes’s record.
        /// One of: <c>match</c>, <c>mismatch</c>, or <c>not_provided</c>.
        /// </summary>
