...
namespace Paayes.Issuing
{
    ...
    public class Transaction : PaayesEntity<Transaction>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// currency and in the <a href="https://docs.paayes.com/currencies#zero-decimal">smallest
        /// currency unit</a>.
        /// </summary>
        [JsonProperty("amount")]
        ...
        /// ID of the <a href="https://docs.paayes.com/api/balance_transactions">balance
        ...
        /// in the <a href="https://docs.paayes.com/currencies#zero-decimal">smallest currency
