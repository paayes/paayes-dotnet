...
namespace Paayes.Issuing
{
    ...
    public class Card : PaayesEntity<Card>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// <a href="https://docs.paayes.com/issuing">issued</a> cards.
        ///
        /// Related guide: <a href="https://docs.paayes.com/issuing/cards#create-cardholder">How to
        ...
        /// href="https://docs.paayes.com/api/expanding_objects">the <c>expand</c> parameter</a>.
        /// Additionally, it's only available via the <a
        /// href="https://docs.paayes.com/api/issuing/cards/retrieve">"Retrieve a card"
