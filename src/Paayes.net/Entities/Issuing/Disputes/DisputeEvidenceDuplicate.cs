...
namespace Paayes.Issuing
{
    ...
    public class DisputeEvidenceDuplicate : PaayesEntity<DisputeEvidenceDuplicate>
    {
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) Copy of
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) Image of
