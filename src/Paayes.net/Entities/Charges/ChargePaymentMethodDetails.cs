...
namespace Paayes
{
    ...
    public class ChargePaymentMethodDetails : PaayesEntity<ChargePaymentMethodDetails>
    {
        ...
        [JsonProperty("paayes_account")]
        public ChargePaymentMethodDetailsPaayesAccount PaayesAccount { get; set; }
        ...
        /// <c>sepa_debit</c>, <c>sofort</c>, <c>paayes_account</c>, or <c>wechat</c>. An additional
