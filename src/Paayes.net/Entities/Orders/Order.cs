...
namespace Paayes
{
    ...
    public class Order : PaayesEntity<Order>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// owner’s Paayes account. The request must be made with an OAuth key or the Paayes-Account
        ...
        public PaayesList<OrderReturn> Returns { get; set; }
        ...
        /// At order creation time, if there are multiple shipping methods, Paayes will
        ...
        /// href="https://docs.paayes.com/orders/guide#understanding-order-statuses">Orders
        /// Guide</a>.
        /// </summary>
        [JsonProperty("status")]
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime Updated { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;

        /// <summary>
        /// The user's order ID if it is different from the Paayes order ID.
        /// </summary>
