...
namespace Paayes
{
    ...
    public class Customer : PaayesEntity<Customer>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Three-letter <a href="https://docs.paayes.com/currencies">ISO code for the currency</a>
        ...
        /// href="https://docs.paayes.com/billing/automatic-collection">dunning</a>,
        ...
        public PaayesList<IPaymentSource> Sources { get; set; }

        /// <summary>
        /// The customer's current subscriptions, if any.
        /// </summary>
        [JsonProperty("subscriptions")]
        public PaayesList<Subscription> Subscriptions { get; set; }
        ...
        public PaayesList<TaxId> TaxIds { get; set; }
    }
}
