...
namespace Paayes
{
    ...
    public class Product : PaayesEntity<Product>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// (ID of the TaxCode)
        /// A <a href="https://docs.paayes.com/tax/tax-codes">tax code</a> ID.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// A label that represents units of this product in Paayes and on customers’ receipts and
