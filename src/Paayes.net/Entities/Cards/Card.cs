...
namespace Paayes
{
    ...
    public class Card : PaayesEntity<Card>, IHasId, IHasMetadata, IHasObject, IExternalAccount, IPaymentSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Three-letter <a href="https://docs.paayes.com/payouts">ISO code for currency</a>. Only
        ...
        /// href="https://support.paayes.com/questions/check-if-a-card-is-valid-without-a-charge">Check
