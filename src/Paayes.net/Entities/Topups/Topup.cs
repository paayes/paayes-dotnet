...
namespace Paayes
{
    ...
    public class Topup : PaayesEntity<Topup>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Date the funds are expected to arrive in your Paayes account for payouts. This factors
        ...
        /// customer's payment instrument, and can be used with the Paayes API just like a
        /// <c>Card</c> object: once chargeable, they can be charged, or can be attached to
        /// customers.
        ///
        /// Related guides: <a href="https://docs.paayes.com/sources">Sources API</a> and <a
        /// href="https://docs.paayes.com/sources/customers">Sources &amp; Customers</a>.
        /// </summary>
        [JsonProperty("source")]
