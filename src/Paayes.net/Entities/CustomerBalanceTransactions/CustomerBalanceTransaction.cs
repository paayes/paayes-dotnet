...
namespace Paayes
{
    ...
    public class CustomerBalanceTransaction : PaayesEntity<CustomerBalanceTransaction>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// href="https://docs.paayes.com/billing/customer/balance#types">Customer Balance page</a>
