...
namespace Paayes
{
    ...
    public class Quote : PaayesEntity<Quote>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// payment and transferred to the application owner's Paayes account. Only applicable if
        ...
        /// to the application owner's Paayes account. Only applicable if there are line items with
        ...
        /// Paayes will attempt to pay invoices at the end of the subscription cycle or on
        /// finalization using the default payment method attached to the subscription or customer.
        /// When sending an invoice, Paayes will email your customer an invoice with payment
        ...
        /// href="https://docs.paayes.com/quotes/clone">cloning documentation</a> for more details.
        /// </summary>
        ...
        public PaayesList<LineItem> LineItems { get; set; }
        ...
        /// quote is <a href="https://docs.paayes.com/quotes/overview#finalize">finalized</a>.
        /// </summary>
        [JsonProperty("number")]
        ...
        /// href="https://support.paayes.com/questions/sending-invoices-on-behalf-of-connected-accounts">Connect
