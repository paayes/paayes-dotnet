...
namespace Paayes
{
    ...
    public class Subscription : PaayesEntity<Subscription>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// to the application owner's Paayes account.
        /// </summary>
        ...
        public DateTime BillingCycleAnchor { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// Paayes will attempt to pay this subscription at the end of the cycle using the default
        /// source attached to the customer. When sending an invoice, Paayes will email your
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime CurrentPeriodEnd { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime CurrentPeriodStart { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// href="https://docs.paayes.com/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a>
        /// or <a
        /// href="https://docs.paayes.com/api/customers/object#customer_object-default_source">default_source</a>.
        /// </summary>
        [JsonIgnore]
        ...
        /// </summary>
        [JsonProperty("items")]
        public PaayesList<SubscriptionItem> Items { get; set; }
        ...
        /// analogous to calling <a href="https://docs.paayes.com/api#create_invoice">Create an
        ...
        /// You can use this <a href="https://docs.paayes.com/api/setup_intents">SetupIntent</a> to
        ...
        /// href="https://docs.paayes.com/billing/migration/strong-customer-authentication#scenario-2">SCA
        /// Migration Guide</a>.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// If specified, <a
        /// href="https://docs.paayes.com/billing/subscriptions/pending-updates">pending updates</a>
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime StartDate { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// subscriptions settings) when Paayes has exhausted all payment retry attempts.
        ///
