...
namespace Paayes
{
    ...
    public class SubscriptionPaymentSettings : PaayesEntity<SubscriptionPaymentSettings>
    {
        /// <summary>
        ...
        /// subscription. If not set, Paayes attempts to automatically determine the types to use by
