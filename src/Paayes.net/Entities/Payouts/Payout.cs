...
namespace Paayes
{
    ...
    public class Payout : PaayesEntity<Payout>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// href="https://docs.paayes.com/payouts#payout-schedule">automated payout schedule</a>,
        /// and <c>false</c> if it was <a
        /// href="https://docs.paayes.com/payouts#manual-payouts">requested manually</a>.
        /// </summary>
        ...
        /// href="https://docs.paayes.com/api#payout_failures">Types of payout failures</a> for a
        ...
        /// href="https://paayes.com/blog/instant-payouts-for-marketplaces">Instant payouts for
