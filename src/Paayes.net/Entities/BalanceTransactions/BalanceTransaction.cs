...
namespace Paayes
{
    ...
    public class BalanceTransaction : PaayesEntity<BalanceTransaction>, IHasId, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// The date the transaction's net funds will become available in the Paayes balance.
        /// </summary>
        [JsonProperty("available_on")]
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime AvailableOn { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        /// 12.34 USD in your Paayes account. Then the BalanceTransaction's <c>amount</c> would be
        ...
        /// <summary>
        /// <a href="https://docs.paayes.com/reports/reporting-categories">Learn more</a> about how
        ...
        /// The Paayes object to which this transaction is related.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// If the transaction's net funds are available in the Paayes balance yet. Either
        ...
        /// <c>reserve_transaction</c>, <c>reserved_funds</c>, <c>paayes_fee</c>,
        /// <c>paayes_fx_fee</c>, <c>tax_fee</c>, <c>topup</c>, <c>topup_reversal</c>,
        /// <c>transfer</c>, <c>transfer_cancel</c>, <c>transfer_failure</c>, or
        /// <c>transfer_refund</c>. <a
        /// href="https://docs.paayes.com/reports/balance-transaction-types">Learn more</a> about
