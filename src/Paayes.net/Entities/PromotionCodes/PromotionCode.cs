...
namespace Paayes
{
    ...
    public class PromotionCode : PaayesEntity<PromotionCode>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// href="https://docs.paayes.com/api#invoices">invoices</a> or <a
        /// href="https://docs.paayes.com/api#create_order-coupon">orders</a>. Coupons do not work
        /// with conventional one-off <a
        /// href="https://docs.paayes.com/api#create_charge">charges</a>.
        /// </summary>
        [JsonProperty("coupon")]
