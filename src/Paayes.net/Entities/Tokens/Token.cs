...
namespace Paayes
{
    ...
    public class Token : PaayesEntity<Token>, IHasId, IHasObject
    {
        /// <summary>
        ...
        ///
        /// On the other hand <a href="https://docs.paayes.com/api#external_accounts">External
        /// Accounts</a> are transfer destinations on <c>Account</c> objects for <a
        /// href="https://docs.paayes.com/connect/custom-accounts">Custom accounts</a>. They can be
        /// bank accounts or debit cards as well, and are documented in the links above.
        ///
        /// Related guide: <a href="https://docs.paayes.com/payments/bank-debits-transfers">Bank
        ...
        /// later.
        ///
        /// Related guide: <a href="https://docs.paayes.com/sources/cards">Card Payments with
        /// Sources</a>.
        /// </summary>
        [JsonProperty("card")]
