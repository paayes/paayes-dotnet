...
namespace Paayes.Reporting
{
    ...
    public class ReportRunParameters : PaayesEntity<ReportRunParameters>
    {
        /// <summary>
        ...
        public DateTime IntervalEnd { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime IntervalStart { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
