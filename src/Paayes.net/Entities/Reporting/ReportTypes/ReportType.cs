...
namespace Paayes.Reporting
{
    ...
    public class ReportType : PaayesEntity<ReportType>, IHasId, IHasObject
    {
        /// <summary>
        /// The <a href="https://docs.paayes.com/reporting/statements/api#available-report-types">ID
        ...
        public DateTime DataAvailableEnd { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
        ...
        [JsonConverter(typeof(UnixDateTimeConverter))]
        public DateTime DataAvailableStart { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
