...
namespace Paayes
{
    ...
    public class ApplicationFee : PaayesEntity<ApplicationFee>, IHasId, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// <summary>
        /// (ID of the Account)
        /// ID of the Paayes account this fee was taken from.
        /// </summary>
        [JsonIgnore]
        ...
        public PaayesList<ApplicationFeeRefund> Refunds { get; set; }
    }
}
