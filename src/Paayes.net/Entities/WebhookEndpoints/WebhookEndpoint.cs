...
namespace Paayes
{
    ...
    public class WebhookEndpoint : PaayesEntity<WebhookEndpoint>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// href="https://docs.paayes.com/webhooks/signatures">webhook signatures</a>. Only returned
        /// at creation.
        /// </summary>
        [JsonProperty("secret")]
