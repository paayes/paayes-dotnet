...
namespace Paayes
{
    ...
    public class BankAccount : PaayesEntity<BankAccount>, IHasId, IHasMetadata, IHasObject, IExternalAccount, IPaymentSource
    {
        /// <summary>
        ...
        /// <summary>
        /// Three-letter <a href="https://docs.paayes.com/payouts">ISO code for the currency</a>
        ...
        /// activity or validation performed is <c>new</c>. If Paayes can determine that the bank
