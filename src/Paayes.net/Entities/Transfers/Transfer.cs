...
namespace Paayes
{
    ...
    public class Transfer : PaayesEntity<Transfer>, IHasId, IHasMetadata, IHasObject, IBalanceTransactionSource
    {
        /// <summary>
        ...
        /// <summary>
        /// (ID of the Account)
        /// ID of the Paayes account the transfer was sent to.
        /// </summary>
        [JsonIgnore]
        ...
        /// <summary>
        /// (ID of the Charge)
        /// If the destination is a Paayes account, this will be the ID of the payment that the
        ...
        public PaayesList<TransferReversal> Reversals { get; set; }
