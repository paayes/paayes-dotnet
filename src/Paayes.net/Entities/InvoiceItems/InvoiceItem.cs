...
namespace Paayes
{
    ...
    public class InvoiceItem : PaayesEntity<InvoiceItem>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        public DateTime Date { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
