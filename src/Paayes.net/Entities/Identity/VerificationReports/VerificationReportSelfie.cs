...
namespace Paayes.Identity
{
    ...
    public class VerificationReportSelfie : PaayesEntity<VerificationReportSelfie>
    {
        /// <summary>
        /// ID of the <a href="https://docs.paayes.com/api/files">File</a> holding the image of the
