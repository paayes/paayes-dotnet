...
namespace Paayes.Identity
{
    ...
    public class VerificationReportDocument : PaayesEntity<VerificationReportDocument>
    {
        /// <summary>
        ...
        /// <summary>
        /// Array of <a href="https://docs.paayes.com/api/files">File</a> ids containing images for
        /// this document.
        /// </summary>
        [JsonProperty("files")]
