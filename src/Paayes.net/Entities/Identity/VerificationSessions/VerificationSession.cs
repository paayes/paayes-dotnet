...
namespace Paayes.Identity
{
    ...
    public class VerificationSession : PaayesEntity<VerificationSession>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// <summary>
        /// The short-lived client secret used by Paayes.js to <a
        /// href="https://docs.paayes.com/js/identity/modal">show a verification modal</a> inside
        ...
        /// docs on <a
        /// href="https://docs.paayes.com/identity/verification-sessions#client-secret">passing the
        ...
        /// href="https://docs.paayes.com/identity/verification-sessions#results">Learn more about
        ...
        /// href="https://docs.paayes.com/identity/how-sessions-work">Learn more about the lifecycle
        /// of sessions</a>.
        ...
        /// <summary>
        /// The short-lived URL that you use to redirect a user to Paayes to submit their identity
        ...
        /// on <a
        /// href="https://docs.paayes.com/identity/verify-identity-documents?platform=web&amp;type=redirect">verifying
        /// identity documents</a> to learn how to redirect users to Paayes.
        /// </summary>
        [JsonProperty("url")]
