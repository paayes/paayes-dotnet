...
namespace Paayes
{
    ...
    public class SetupIntent : PaayesEntity<SetupIntent>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        public PaayesError LastSetupError { get; set; }
        ...
        /// <summary>
        /// <a href="https://docs.paayes.com/payments/intents#intent-statuses">Status</a> of this
