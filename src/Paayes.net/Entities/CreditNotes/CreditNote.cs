...
namespace Paayes
{
    ...
    public class CreditNote : PaayesEntity<CreditNote>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("lines")]
        public PaayesList<CreditNoteLineItem> Lines { get; set; }
        ...
        /// <summary>
        /// Amount that was credited outside of Paayes.
        /// </summary>
        ...
        /// href="https://docs.paayes.com/billing/invoices/credit-notes#voiding">voiding credit
        /// notes</a>.
