...
namespace Paayes
{
    ...
    public class AccountSettingsBranding : PaayesEntity<AccountSettingsBranding>
    {
        #region Expandable Icon

        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) An icon
        ...
        /// <summary>
        /// (ID of the File)
        /// (ID of a <a href="https://docs.paayes.com/guides/file-upload">file upload</a>) A logo
