...
namespace Paayes
{
    ...
    public class Account : PaayesEntity<Account>, IHasId, IHasMetadata, IHasObject, IPaymentSource
    {
        /// <summary>
        ...
        public PaayesList<IExternalAccount> ExternalAccounts { get; set; }
        ...
        /// href="https://docs.paayes.com/connect/standard-accounts">Standard onboarding</a> or <a
        /// href="https://docs.paayes.com/connect/express-accounts">Express onboarding
        /// documentation</a> for information about platform pre-filling and account onboarding
        /// steps.
        ///
        /// Related guide: <a
        /// href="https://docs.paayes.com/connect/identity-verification-api#person-information">Handling
        ...
        /// <summary>
        /// Whether Paayes can send payouts to this account.
        /// </summary>
        ...
        /// <summary>
        /// The Paayes account type. Can be <c>standard</c>, <c>express</c>, or <c>custom</c>.
