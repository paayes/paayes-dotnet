...
namespace Paayes
{
    ...
    public class AccountCompany : PaayesEntity<AccountCompany>
    {
        ...
        /// href="https://docs.paayes.com/api/accounts/update#update_account-company-directors_provided">the
        ...
        /// href="https://docs.paayes.com/api/accounts/update#update_account-company-executives_provided">the
        /// <c>executives_provided</c> parameter</a>, or if Paayes determined that sufficient
        ...
        /// href="https://docs.paayes.com/api/accounts/update#update_account-company-owners_provided">the
        /// <c>owners_provided</c> parameter</a>, or if Paayes determined that sufficient owners
        /// were provided. Paayes determines ownership requirements using both the number of owners
        ...
        /// href="https://docs.paayes.com/connect/identity-verification#business-structure">Business
