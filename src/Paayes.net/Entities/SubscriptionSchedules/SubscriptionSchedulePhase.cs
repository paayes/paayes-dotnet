...
namespace Paayes
{
    ...
    public class SubscriptionSchedulePhase : PaayesEntity<SubscriptionSchedulePhase>
    {
        /// <summary>
        ...
        /// to the application owner's Paayes account during this phase of the schedule.
        /// </summary>
        ...
        public DateTime EndDate { get; set; } = Paayes.Infrastructure.DateTimeUtils.UnixEpoch;
