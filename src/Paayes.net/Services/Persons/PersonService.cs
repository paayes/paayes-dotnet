...
namespace Paayes
{
        ...
        INestedUpdatable<Person, PersonUpdateOptions>
    {
        ...
        public PersonService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/accounts/{PARENT_ID}/persons";
        ...
        public virtual PaayesList<Person> List(string parentId, PersonListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options, requestOptions);
        }

        public virtual Task<PaayesList<Person>> ListAsync(string parentId, PersonListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
