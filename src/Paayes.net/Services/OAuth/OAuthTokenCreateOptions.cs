namespace Paayes
{
    ...
    {
        /// <summary>
        /// If you <see href="https://docs.paayes.com/connect/express-accounts#specify-capabilities">specified a Capability</see>
        /// using the <see cref="OAuthAuthorizeUrlOptions.SuggestedCapabilities"/> parameter, you
        /// can verify that Paayes applied the suggested Capability in this POST request by
