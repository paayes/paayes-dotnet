namespace Paayes
{
    ...
    public class OAuthAuthorizeUrlOptions : BaseOptions
    {
        ...
        /// <see href="https://dashboard.paayes.com/account/applications/settings">application settings</see>.
        /// </summary>
        ...
        /// <see href="https://docs.paayes.com/connect/oauth-reference#get-authorize-response">response</see>
        ...
        /// Paayes accounts already (e.g., most read-only applications, like analytics dashboards or
        /// accounting software).
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </summary>
        [JsonProperty("paayes_landing")]
        public string PaayesLanding { get; set; }

        /// <summary>Prefilled details in the account form for new users.</summary>
        [JsonProperty("paayes_user")]
        public OAuthAuthorizeUrlPaayesUserOptions PaayesUser { get; set; }

        /// <summary>
        /// If your platform is designated for one
        /// <see href="https://docs.paayes.com/connect/capabilities-overview">Capability</see>
