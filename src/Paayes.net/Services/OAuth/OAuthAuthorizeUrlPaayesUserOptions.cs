namespace Paayes
{
    ...
    public class OAuthAuthorizeUrlPaayesUserOptions : INestedOptions
    {
        /// <summary>
        ...
        /// <para>Must be a country that Paayes currently supports.</para>
        /// </summary>
        ...
        /// </para>
        /// <para>Must be a valid country and currency combination that Paayes supports.</para>
        ...
        /// <summary>
        /// <para>
        /// Day (<c>1-31</c>) for the birth date of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// Month (<c>1-12</c>) for the birth date of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        ...
        /// filling out a Paayes application.
        /// </para>
        /// <para>
        /// If filling this property, you must also fill <see cref="DobDay"/> and
        /// <see cref="DobMonth"/>.
        ...
        /// <summary>First name of the person who will be filling out a Paayes application.</summary>
        [JsonProperty("first_name")]
        public string FirstName { get; set; }

        /// <summary>
        /// <para>
        /// The Kana variation of the first name of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// The Kanji variation of the first name of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        /// Must prefill <see cref="Country"/> with <c>JP</c>, as this parameter is only relevant
        ...
        /// <summary>
        /// <para>
        /// The gender of the person who will be filling out a Paayes application. (International
        ...
        /// <summary>Last name of the person who will be filling out a Paayes application.</summary>
        [JsonProperty("last_name")]
        public string LastName { get; set; }

        /// <summary>
        /// <para>
        /// The Kana variation of the last name of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        /// Must prefill <see cref="Country"/> with <c>JP</c>, as this parameter is only relevant
        ...
        /// <summary>
        /// <para>
        /// The Kanji variation of the last name of the person who will be filling out a Paayes
        /// application.
        /// </para>
        /// <para>
        /// Must prefill <see cref="Country"/> with <c>JP</c>, as this parameter is only relevant
