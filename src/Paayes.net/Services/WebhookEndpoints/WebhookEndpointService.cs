...
namespace Paayes
{
        ...
        IUpdatable<WebhookEndpoint, WebhookEndpointUpdateOptions>
    {
        ...
        public WebhookEndpointService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/webhook_endpoints";
        ...
        public virtual PaayesList<WebhookEndpoint> List(WebhookEndpointListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<WebhookEndpoint>> ListAsync(WebhookEndpointListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
