...
namespace Paayes
{
        ...
        IUpdatable<Order, OrderUpdateOptions>
    {
        ...
        public OrderService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/orders";
        ...
        public virtual PaayesList<Order> List(OrderListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Order>> ListAsync(OrderListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
