...
namespace Paayes
{
    ...
    public class OrderPayOptions : BaseOptions, IHasMetadata
    {
        ...
        /// Paayes account. The request must be made with an OAuth key or the <c>Paayes-Account</c>
        ...
        /// <summary>
        /// A <a href="https://docs.paayes.com/api#tokens">Token</a>'s or a <a
        /// href="https://docs.paayes.com/api#sources">Source</a>'s ID, as returned by <a
        /// href="https://docs.paayes.com/elements">Elements</a>. If no customer was attached to the
