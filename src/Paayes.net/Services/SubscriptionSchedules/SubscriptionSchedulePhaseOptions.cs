...
namespace Paayes
{
    ...
    public class SubscriptionSchedulePhaseOptions : INestedOptions
    {
        ...
        /// to the application owner's Paayes account. The request must be made by a platform
        ...
        /// href="https://docs.paayes.com/connect/subscriptions#collecting-fees-on-subscriptions">documentation</a>.
        /// </summary>
        ...
        /// billing cycle <a
        /// href="https://docs.paayes.com/billing/subscriptions/billing-cycle">documentation</a>.
        ...
        /// Paayes will attempt to pay the underlying subscription at the end of each billing cycle
        /// using the default source attached to the customer. When sending an invoice, Paayes will
        ...
        /// href="https://docs.paayes.com/api/invoices/create#create_invoice-default_tax_rates"><c>default_tax_rates</c></a>
        ...
        /// href="https://docs.paayes.com/billing/subscriptions/prorations">Prorations</a>.
