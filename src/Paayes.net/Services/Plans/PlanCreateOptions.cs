...
namespace Paayes
{
    ...
    public class PlanCreateOptions : BaseOptions, IHasId, IHasMetadata
    {
        ...
        /// <summary>
        /// An identifier randomly generated by Paayes. Used to identify this plan when subscribing
        /// a customer. You can optionally override this ID, but the ID must be unique across all
        /// plans in your Paayes account. You can, however, use the same plan ID in both live and
        /// test modes.
        /// </summary>
        [JsonProperty("id")]
