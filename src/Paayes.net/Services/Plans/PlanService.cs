...
namespace Paayes
{
        ...
        IUpdatable<Plan, PlanUpdateOptions>
    {
        ...
        public PlanService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/plans";
        ...
        public virtual PaayesList<Plan> List(PlanListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Plan>> ListAsync(PlanListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
