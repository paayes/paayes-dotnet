...
namespace Paayes
{
    ...
    public class QuoteCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// payment and transferred to the application owner's Paayes account. There cannot be any
        ...
        /// to the application owner's Paayes account. There must be at least 1 line item with a
        ...
        /// Paayes will attempt to pay invoices at the end of the subscription cycle or at invoice
        ...
        /// href="https://dashboard.paayes.com/settings/billing/quote">quote template settings</a>
        /// will be used.
        /// </summary>
