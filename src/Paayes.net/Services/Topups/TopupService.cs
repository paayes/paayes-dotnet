...
namespace Paayes
{
        ...
        IUpdatable<Topup, TopupUpdateOptions>
    {
        ...
        public TopupService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/topups";
        ...
        public virtual PaayesList<Topup> List(TopupListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Topup>> ListAsync(TopupListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
