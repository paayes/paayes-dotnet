...
namespace Paayes
{
        ...
        INestedUpdatable<Capability, CapabilityUpdateOptions>
    {
        ...
        public CapabilityService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/accounts/{PARENT_ID}/capabilities";
        ...
        public virtual PaayesList<Capability> List(string parentId, CapabilityListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options, requestOptions);
        }

        public virtual Task<PaayesList<Capability>> ListAsync(string parentId, CapabilityListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
