...
namespace Paayes
{
        ...
        IUpdatable<SubscriptionItem, SubscriptionItemUpdateOptions>
    {
        ...
        public SubscriptionItemService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/subscription_items";
        ...
        public virtual PaayesList<SubscriptionItem> List(SubscriptionItemListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<SubscriptionItem>> ListAsync(SubscriptionItemListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
