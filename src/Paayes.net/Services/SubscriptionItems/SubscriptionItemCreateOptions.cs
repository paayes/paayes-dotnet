...
namespace Paayes
{
    ...
    public class SubscriptionItemCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// href="https://docs.paayes.com/billing/migration/strong-customer-authentication">SCA
        ...
        /// href="https://docs.paayes.com/billing/subscriptions/pending-updates">pending
        /// updates</a>. When you use <c>pending_if_incomplete</c> you can only pass the parameters
        /// <a
        /// href="https://docs.paayes.com/billing/pending-updates-reference#supported-attributes">supported
        /// by pending updates</a>.
        ///
        /// Use <c>error_if_incomplete</c> if you want Paayes to return an HTTP 402 status code if a
        ...
        /// href="https://docs.paayes.com/upgrades#2019-03-14">changelog</a> to learn more.
        ...
        /// <summary>
        /// Data used to generate a new <a href="https://docs.paayes.com/api/prices">Price</a>
        /// object inline.
        /// </summary>
        ...
        /// href="https://docs.paayes.com/subscriptions/billing-cycle#prorations">prorations</a>
        ...
        /// href="https://docs.paayes.com/subscriptions/upgrading-downgrading#immediate-payment">certain
        ...
        /// href="https://docs.paayes.com/api#retrieve_customer_invoice">upcoming invoice</a>
        /// endpoint.
        /// </summary>
        ...
        /// <summary>
        /// A list of <a href="https://docs.paayes.com/api/tax_rates">Tax Rate</a> ids. These Tax
        /// Rates will override the <a
        /// href="https://docs.paayes.com/api/subscriptions/create#create_subscription-default_tax_rates"><c>default_tax_rates</c></a>
