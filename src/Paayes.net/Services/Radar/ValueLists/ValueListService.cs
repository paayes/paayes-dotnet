...
namespace Paayes.Radar
{
        ...
        IUpdatable<ValueList, ValueListUpdateOptions>
    {
        ...
        public ValueListService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/radar/value_lists";
        ...
        public virtual PaayesList<ValueList> List(ValueListListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<ValueList>> ListAsync(ValueListListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
