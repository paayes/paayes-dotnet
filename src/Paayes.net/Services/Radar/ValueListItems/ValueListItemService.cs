...
namespace Paayes.Radar
{
        ...
        IRetrievable<ValueListItem, ValueListItemGetOptions>
    {
        ...
        public ValueListItemService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/radar/value_list_items";
        ...
        public virtual PaayesList<ValueListItem> List(ValueListItemListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<ValueListItem>> ListAsync(ValueListItemListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
