...
namespace Paayes
{
        ...
        INestedUpdatable<CustomerBalanceTransaction, CustomerBalanceTransactionUpdateOptions>
    {
        ...
        public CustomerBalanceTransactionService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/customers/{PARENT_ID}/balance_transactions";
        ...
        public virtual PaayesList<CustomerBalanceTransaction> List(string parentId, CustomerBalanceTransactionListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options, requestOptions);
        }

        public virtual Task<PaayesList<CustomerBalanceTransaction>> ListAsync(string parentId, CustomerBalanceTransactionListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
