...
namespace Paayes.Issuing
{
        ...
        IUpdatable<Cardholder, CardholderUpdateOptions>
    {
        ...
        public CardholderService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/issuing/cardholders";
        ...
        public virtual PaayesList<Cardholder> List(CardholderListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Cardholder>> ListAsync(CardholderListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
