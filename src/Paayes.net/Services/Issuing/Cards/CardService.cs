...
namespace Paayes.Issuing
{
        ...
        IUpdatable<Card, CardUpdateOptions>
    {
        ...
        public override string BasePath => "/api/v1/issuing/cards";
        ...
        public virtual PaayesList<Card> List(CardListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Card>> ListAsync(CardListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
