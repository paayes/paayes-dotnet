...
namespace Paayes.Issuing
{
        ...
        IUpdatable<Dispute, DisputeUpdateOptions>
    {
        ...
        public DisputeService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/issuing/disputes";
        ...
        public virtual PaayesList<Dispute> List(DisputeListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Dispute>> ListAsync(DisputeListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
