...
namespace Paayes
{
    ...
    {
        /// <summary>
        /// A Boolean indicating whether Paayes should try to reclaim negative balances from an
        ...
        /// href="https://docs.paayes.com/connect/bank-transfers#payout-information">Setting Bank
