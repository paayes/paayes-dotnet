...
namespace Paayes
{
        ...
        IUpdatable<Coupon, CouponUpdateOptions>
    {
        ...
        public CouponService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/coupons";
        ...
        public virtual PaayesList<Coupon> List(CouponListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Coupon>> ListAsync(CouponListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
