...
namespace Paayes
{
    ...
    {
        /// <summary>
        /// The parameters required to notify Paayes of a mandate acceptance or refusal by the
        /// customer.
        /// </summary>
        ...
        /// <summary>
        /// The method Paayes should use to notify the customer of upcoming debit instructions
