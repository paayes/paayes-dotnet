...
namespace Paayes
{
        ...
        IUpdatable<Customer, CustomerUpdateOptions>
    {
        ...
        public CustomerService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/customers";
        ...
        public virtual PaayesList<Customer> List(CustomerListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Customer>> ListAsync(CustomerListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
