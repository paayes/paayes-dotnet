...
namespace Paayes
{
        ...
        IUpdatable<Payout, PayoutUpdateOptions>
    {
        ...
        public PayoutService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/payouts";
        ...
        public virtual PaayesList<Payout> List(PayoutListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Payout>> ListAsync(PayoutListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
