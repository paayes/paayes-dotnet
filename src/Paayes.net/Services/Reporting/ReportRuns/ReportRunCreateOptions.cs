...
namespace Paayes.Reporting
{
    ...
    public class ReportRunCreateOptions : BaseOptions
    {
        ...
        /// href="https://docs.paayes.com/reporting/statements/api">API Access to Reports</a>
        /// documentation.
        /// </summary>
        ...
        /// <summary>
        /// The ID of the <a
        /// href="https://docs.paayes.com/reporting/statements/api#report-types">report type</a> to
