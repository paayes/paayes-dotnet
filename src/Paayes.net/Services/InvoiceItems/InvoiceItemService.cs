...
namespace Paayes
{
        ...
        IUpdatable<InvoiceItem, InvoiceItemUpdateOptions>
    {
        ...
        public InvoiceItemService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/invoiceitems";
        ...
        public virtual PaayesList<InvoiceItem> List(InvoiceItemListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<InvoiceItem>> ListAsync(InvoiceItemListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
