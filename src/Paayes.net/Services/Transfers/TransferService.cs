...
namespace Paayes
{
        ...
        IUpdatable<Transfer, TransferUpdateOptions>
    {
        ...
        public TransferService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/transfers";
        ...
        public virtual PaayesList<Transfer> List(TransferListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Transfer>> ListAsync(TransferListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
