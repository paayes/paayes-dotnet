...
namespace Paayes
{
    ...
    public class TransferCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// <summary>
        /// 3-letter <a href="https://docs.paayes.com/payouts">ISO code for currency</a>.
        /// </summary>
        ...
        /// <summary>
        /// The ID of a connected Paayes account. &lt;a
        ...
        /// href="https://docs.paayes.com/connect/charges-transfers#transfer-availability">See the
