...
namespace Paayes
{
        ...
        IUpdatable<FileLink, FileLinkUpdateOptions>
    {
        ...
        public FileLinkService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/file_links";
        ...
        public virtual PaayesList<FileLink> List(FileLinkListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<FileLink>> ListAsync(FileLinkListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
