...
namespace Paayes
{
        ...
        IUpdatable<Product, ProductUpdateOptions>
    {
        ...
        public ProductService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/products";
        ...
        public virtual PaayesList<Product> List(ProductListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Product>> ListAsync(ProductListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
