...
namespace Paayes
{
    ...
    public class ProductCreateOptions : BaseOptions, IHasId, IHasMetadata
    {
        ...
        /// <summary>
        /// An identifier will be randomly generated by Paayes. You can optionally override this ID,
        /// but the ID must be unique across all products in your Paayes account.
        /// </summary>
        [JsonProperty("id")]
