...
namespace Paayes
{
    ...
    public class SetupIntentCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// with <a
        /// href="https://docs.paayes.com/api/setup_intents/create#create_setup_intent-confirm"><c>confirm=true</c></a>.
        /// </summary>
        ...
        /// <summary>
        /// The Paayes account ID for which this SetupIntent is created.
        /// </summary>
