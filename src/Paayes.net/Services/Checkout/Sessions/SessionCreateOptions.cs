...
namespace Paayes.Checkout
{
    ...
    public class SessionCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// href="https://docs.paayes.com/api/customers/update#update_customer-invoice_settings-default_payment_method">default
        ...
        ///
        /// You can set <a
        /// href="https://docs.paayes.com/api/checkout/sessions/create#create_checkout_session-payment_intent_data-setup_future_usage"><c>payment_intent_data.setup_future_usage</c></a>
        ...
        /// recurring <a href="https://docs.paayes.com/api/prices">Prices</a>.
        ///
        ...
        /// href="https://docs.paayes.com/payments/checkout/payment-methods">payment method details
        /// guide</a>.
        ///
        ...
        /// <summary>
        /// The URL to which Paayes should send customers when payment or setup is complete. If
        /// you’d like access to the Checkout Session for the successful payment, read more about it
        /// in the guide on <a
        /// href="https://docs.paayes.com/payments/checkout/fulfill-orders">fulfilling orders</a>.
        /// </summary>
