...
namespace Paayes.Checkout
{
    ...
    public class SessionSubscriptionDataOptions : INestedOptions, IHasMetadata
    {
        ...
        /// to the application owner's Paayes account. To use an application fee percent, the
        /// request must be made on behalf of another account, using the <c>Paayes-Account</c>
