namespace Paayes
{
        ...
        INestedUpdatable<Card, CardUpdateOptions>
    {
        ...
        public CardService(IPaayesClient client)
            : base(client)
        {
        }
        ...
        public virtual PaayesList<Card> List(string parentId, CardListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options ?? new CardListOptions(), requestOptions);
        }

        public virtual Task<PaayesList<Card>> ListAsync(string parentId, CardListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
