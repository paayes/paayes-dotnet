...
namespace Paayes
{
        ...
        IRetrievable<ApplePayDomain, ApplePayDomainGetOptions>
    {
        ...
        public ApplePayDomainService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/apple_pay/domains";
        ...
        public virtual PaayesList<ApplePayDomain> List(ApplePayDomainListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<ApplePayDomain>> ListAsync(ApplePayDomainListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
