...
namespace Paayes
{
        ...
        INestedUpdatable<ApplicationFeeRefund, ApplicationFeeRefundUpdateOptions>
    {
        ...
        public ApplicationFeeRefundService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/application_fees/{PARENT_ID}/refunds";
        ...
        public virtual PaayesList<ApplicationFeeRefund> List(string parentId, ApplicationFeeRefundListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options, requestOptions);
        }

        public virtual Task<PaayesList<ApplicationFeeRefund>> ListAsync(string parentId, ApplicationFeeRefundListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
