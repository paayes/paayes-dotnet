...
namespace Paayes.BillingPortal
{
        ...
        IUpdatable<Configuration, ConfigurationUpdateOptions>
    {
        ...
        public ConfigurationService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/billing_portal/configurations";
        ...
        public virtual PaayesList<Configuration> List(ConfigurationListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Configuration>> ListAsync(ConfigurationListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
