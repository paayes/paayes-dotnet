...
namespace Paayes.BillingPortal
{
    ...
    public class SessionCreateOptions : BaseOptions
    {
        ...
        /// href="https://docs.paayes.com/api/customer_portal/configuration">configuration</a> to
        ...
        /// href="https://docs.paayes.com/connect/charges-transfers#on-behalf-of">docs</a>. Use the
        /// <a
        /// href="https://docs.paayes.com/api/accounts/object#account_object-settings-branding">Accounts
