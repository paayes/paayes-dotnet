...
namespace Paayes
{
        ...
        INestedRetrievable<TaxId, TaxIdGetOptions>
    {
        ...
        public TaxIdService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/customers/{PARENT_ID}/tax_ids";
        ...
        public virtual PaayesList<TaxId> List(string parentId, TaxIdListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options, requestOptions);
        }

        public virtual Task<PaayesList<TaxId>> ListAsync(string parentId, TaxIdListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
