...
namespace Paayes
{
    ...
    public class TokenAccountCompanyOptions : INestedOptions
    {
        ...
        /// href="https://docs.paayes.com/api/persons">the Persons API</a> for accounts with a
        ...
        /// creating all the company's owners with <a href="https://docs.paayes.com/api/persons">the
