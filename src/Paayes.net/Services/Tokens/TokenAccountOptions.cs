...
namespace Paayes
{
    ...
    public class TokenAccountOptions : INestedOptions
    {
        ...
        /// href="https://docs.paayes.com/connect/account-tokens#paayes-connected-account-agreement">the
        /// Paayes Connected Account Agreement</a>. When creating an account token to create a new
