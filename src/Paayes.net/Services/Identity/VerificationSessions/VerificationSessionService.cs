...
namespace Paayes.Identity
{
        ...
        IUpdatable<VerificationSession, VerificationSessionUpdateOptions>
    {
        ...
        public VerificationSessionService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/identity/verification_sessions";
        ...
        public virtual PaayesList<VerificationSession> List(VerificationSessionListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<VerificationSession>> ListAsync(VerificationSessionListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
