...
namespace Paayes
{
    ...
    public class ChargeCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// much to charge in the <a href="https://docs.paayes.com/currencies#zero-decimal">smallest
        ...
        /// owner's Paayes account. The request must be made with an OAuth key or the
        /// <c>Paayes-Account</c> header in order to take an application fee. For more information,
        /// see the application fees <a
        /// href="https://docs.paayes.com/connect/direct-charges#collecting-fees">documentation</a>.
        /// </summary>
        ...
        /// href="https://docs.paayes.com/api#capture_charge">captured</a> later. Uncaptured charges
        /// expire in <em>seven days</em>. For more information, see the <a
        /// href="https://docs.paayes.com/charges/placing-a-hold">authorizing charges and settling
        ...
        /// in the web interface alongside the charge. Note that if you use Paayes to send automatic
        ...
        /// <summary>
        /// The Paayes account ID for which these funds are intended. Automatically set if you use
        /// the <c>destination</c> parameter. For details, see <a
        /// href="https://docs.paayes.com/connect/charges-transfers#on-behalf-of">Creating Separate
        ...
        /// href="https://docs.paayes.com/dashboard/receipts">receipt</a> will be sent. The receipt
        /// will not be sent until the charge is paid, and no receipts will be sent for test mode
        /// charges. If this charge is for a <a
        /// href="https://docs.paayes.com/api/customers/object">Customer</a>, the email address
        ...
        /// href="https://dashboard.paayes.com/account/emails">email settings</a>.
        /// </summary>
        ...
        /// destination charge. <a href="https://docs.paayes.com/connect/destination-charges">See
        ...
        /// href="https://docs.paayes.com/connect/charges-transfers#transfer-options">Grouping
        /// transactions</a>.
        /// </summary>
