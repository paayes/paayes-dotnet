...
namespace Paayes
{
    ...
    public class ChargeUpdateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// web interface alongside the charge. Note that if you use Paayes to send automatic email
        ...
        /// <c>user_report</c> key with a value of <c>safe</c>. Paayes will use the information you
