...
namespace Paayes
{
        ...
        IUpdatable<Charge, ChargeUpdateOptions>
    {
        ...
        public ChargeService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/charges";
        ...
        public virtual PaayesList<Charge> List(ChargeListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Charge>> ListAsync(ChargeListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
