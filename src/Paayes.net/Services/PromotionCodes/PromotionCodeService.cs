...
namespace Paayes
{
        ...
        IUpdatable<PromotionCode, PromotionCodeUpdateOptions>
    {
        ...
        public PromotionCodeService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/promotion_codes";
        ...
        public virtual PaayesList<PromotionCode> List(PromotionCodeListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<PromotionCode>> ListAsync(PromotionCodeListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
