...
namespace Paayes
{
        ...
        IUpdatable<PaymentMethod, PaymentMethodUpdateOptions>
    {
        ...
        public PaymentMethodService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/payment_methods";
        ...
        public virtual PaayesList<PaymentMethod> List(PaymentMethodListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<PaymentMethod>> ListAsync(PaymentMethodListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
