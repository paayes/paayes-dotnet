...
namespace Paayes
{
        ...
        IUpdatable<TaxRate, TaxRateUpdateOptions>
    {
        ...
        public TaxRateService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/tax_rates";
        ...
        public virtual PaayesList<TaxRate> List(TaxRateListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<TaxRate>> ListAsync(TaxRateListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
