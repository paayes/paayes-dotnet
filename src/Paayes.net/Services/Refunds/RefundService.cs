...
namespace Paayes
{
        ...
        IUpdatable<Refund, RefundUpdateOptions>
    {
        ...
        public RefundService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/refunds";
        ...
        public virtual PaayesList<Refund> List(RefundListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Refund>> ListAsync(RefundListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
