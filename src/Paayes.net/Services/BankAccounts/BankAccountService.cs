namespace Paayes
{
        ...
        INestedUpdatable<BankAccount, BankAccountUpdateOptions>
    {
        ...
        public BankAccountService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/customers/{PARENT_ID}/sources";
        ...
        public virtual PaayesList<BankAccount> List(string parentId, BankAccountListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListNestedEntities(parentId, options ?? new BankAccountListOptions(), requestOptions);
        }

        public virtual Task<PaayesList<BankAccount>> ListAsync(string parentId, BankAccountListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
