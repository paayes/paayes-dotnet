...
namespace Paayes.Terminal
{
        ...
        IUpdatable<Location, LocationUpdateOptions>
    {
        ...
        public LocationService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/terminal/locations";
        ...
        public virtual PaayesList<Location> List(LocationListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Location>> ListAsync(LocationListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
