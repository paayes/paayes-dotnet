...
namespace Paayes.Terminal
{
        ...
        IUpdatable<Reader, ReaderUpdateOptions>
    {
        ...
        public ReaderService(IPaayesClient client)
            : base(client)
        {
        }

        public override string BasePath => "/api/v1/terminal/readers";
        ...
        public virtual PaayesList<Reader> List(ReaderListOptions options = null, RequestOptions requestOptions = null)
        {
            return this.ListEntities(options, requestOptions);
        }

        public virtual Task<PaayesList<Reader>> ListAsync(ReaderListOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
