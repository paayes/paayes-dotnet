namespace Paayes
{
        ...
        where TEntityReturned : IPaayesEntity
    {
        ...
        protected ServiceNested(IPaayesClient client)
            : base(client)
        {
        }
        ...
        protected PaayesList<TEntityReturned> ListNestedEntities(
            string parentId,
            ListOptions options,
            RequestOptions requestOptions)
        {
        ...
        protected Task<PaayesList<TEntityReturned>> ListNestedEntitiesAsync(
            string parentId,
            ListOptions options,
            RequestOptions requestOptions,
            CancellationToken cancellationToken)
